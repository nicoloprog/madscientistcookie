  ...
  return (
    <section className="relative min-h-[100svh] w-full overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-full min-h-[100svh] mx-auto md:mx-30 px-6 pt-24 md:min-w-[90%]">
        {/* Heading */}
        <h2
          className={`${sansitaSwashed.className} text-4xl md:text-5xl lg:text-7xl text-[#c9a227] italic mb-6 md:mb-18`}
        >
          Our Laboratory
        </h2>

        {/* Description text - left on mobile, centered on desktop */}
        <p className="text-[#c9a227] text-lg md:text-2xl leading-relaxed max-w-full md:min-w-[100%] lg:max-w-5xl text-left md:text-center md:mx-auto">
