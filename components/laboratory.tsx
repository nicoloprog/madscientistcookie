    ...
    <section className="relative min-h-[100svh] md:min-h-[105svh] w-full">
      ...
      <div className="relative z-10 flex flex-col h-full min-h-[100svh] mx-auto px-6 pt-12 md:pt-24 md:px-20">
        ...
        <p className="md:hidden text-[#c9a227] text-sm leading-relaxed">
          Built in Las Vegas. Engineered with Obsession. I&apos;m a Canadian
          bodybuilder turned cookie perfectionist, now baking big in Las Vegas.
          I started in my mom&apos;s restaurant kitchen at 10 years old. What
          began as passion turned into obsession. Bodybuilding taught me
          discipline. Baking became my creative outlet. And in a city that never
          does anything halfway, neither do I. Every cookie is built with
        ...
        {/* ---------------- DESKTOP TEXT ---------------- */}
        <p className="hidden md:block text-[#c9a227] text-md lg:text-2xl leading-relaxed w-full">
          ...
          feeding my friends like they were judges on a cooking
          show.Bodybuilding taught me discipline. Las Vegas taught me scale.
          Baking taught me love. Now I bring all three together.Every cookie I
          create is built with precision — the perfect chew, the gooey center,
          the balance of salt and sweet, the finish that lingers. Most people
          say, “That&apos;s too much.” For me? It&apos;s never enough.
          <br />
          <br />
